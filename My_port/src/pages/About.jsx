...
import girlImg from '../../public/girl2.jpg';
...
const About = () => (
  <section className="max-w-7xl mx-auto px-2 py-20 flex flex-col md:flex-row items-center gap-6">
    ...
    <div className="flex-1">
      ...
      <p className="text-gray-500 mb-6">Currently, I'm working as a MERN Stack Developer Trainee at Adam Finastra Pvt.Ltd, Incubation Centre, MCET Thrissur. I enjoy working with React, Node.js, Mongodb and exploring new tech trends.</p>
      <a href="/Krishna__Pushpan.pdf" download className="bg-gray-900 text-white px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-800 transition inline-block">Download CV</a>
    </div>
    {/* Image */}
